...
with open("sql/mwp.sql", "r", encoding="utf-8") as fil:
    QUERY = fil.read()

def hent_mvp(month: str, dbnavn: "sql/test.db"):
    måned_start = f'{år:04d}-{måned:02d}-01'
...
if __name__ == "__main__":
    ...
    kolonner, rader = hent_mvp(år=år, måned=month)
